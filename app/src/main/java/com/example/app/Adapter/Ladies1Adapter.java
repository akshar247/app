...
public class Ladies1Adapter extends RecyclerView.Adapter<Ladies1Adapter.MyViewHolder> {
    private Context mContext;
    private List<Ladies1> mData;

    public Ladies1Adapter(Context mContext, List<Ladies1> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view=mInflater.inflate(R.layout.ladies1_item,parent,false);
